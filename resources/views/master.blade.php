...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <!-- dataTables -->
      <script src="{{ URL('/') }}/public/datatables/dataTables.buttons.min.js"></script>
      <script src="{{ URL('/') }}/public/datatables/dataTables.bootstrap.min.js"></script>
      <script src="{{ URL('/') }}/public/datatables/buttons.flash.min.js">"></script>
      <script src="{{ URL('/') }}/public/datatables/jszip.min.js">"></script>
      <script src="{{ URL('/') }}/public/datatables/pdfmake.min.js">"></script>
      <script src="{{ URL('/') }}/public/datatables/vfs_fonts.js">"></script>
      <script src="{{ URL('/') }}/public/datatables/buttons.html5.min.js">"></script>
      <script src="{{ URL('/') }}/public/datatables/buttons.print.min.js"></script>
      ...
      <nav class="navbar">
         <div class="container-fluid">
            <div class="">
               ...
               <a class="navbar-brand" href="{{ URL('/') }}"><img src="{{ url('/') }}/public/images/jthp2.png" alt=""></a>
